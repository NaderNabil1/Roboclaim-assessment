...
<p style="margin:0 0 20px 0;font-size:15px;line-height:1.6;color:#475569;">
    Thank you for adding your policy. We have received it successfully and it is now <strong style="color:#0f172a;">waiting for admin approval</strong> before it can be used for claims.
</p>
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0 0 24px 0;background-color:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;">
    ...
    <tr>
        <td style="padding:0 18px 16px 18px;font-size:14px;color:#475569;">
            <span style="display:block;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.06em;color:#64748b;margin-bottom:6px;">Current status</span>
            {{ $statusLabel }}
        </td>
    </tr>
</table>
...
<p style="margin:16px 0 0 0;font-size:13px;line-height:1.5;color:#94a3b8;">
    We will notify you again when your policy status changes.
</p>
@endsection
