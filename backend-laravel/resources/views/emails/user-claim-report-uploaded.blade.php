...
<p style="margin:0 0 20px 0;font-size:15px;line-height:1.6;color:#475569;">
    Your claim report was uploaded successfully. Our team may review it and you will receive another email if the status changes.
</p>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0;">
    <tr>
        <td style="border-radius:8px;background-color:#0f172a;">
            <a href="{{ $claimsUrl }}" style="display:inline-block;padding:12px 22px;font-family:ui-sans-serif,system-ui,sans-serif;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none;">
                View my claims
            </a>
        </td>
    </tr>
